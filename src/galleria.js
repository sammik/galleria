...
Galleria.prototype = {
    ...
    */
    ...
    _init: function() {
        ...
        // add a notouch class on the container to prevent unwanted :hovers on touch devices; add variations, theme name, carousel classes
        this.$( 'container' ).addClass([
            ( Galleria.TOUCH ? 'touch' : 'notouch' ),
            ( (this._options.carousel === "vertical") ? 'vertical' : this._options.carousel ? 'horizontal' : '' ),
